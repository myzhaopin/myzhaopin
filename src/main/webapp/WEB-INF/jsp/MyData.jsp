                ...
                <td colspan="2" valign="top">
                    <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td align="left" class="text_cray"><input class="form-control" type="text" name="telphone"/></td>
                        </tr>
                        <tr>
                            <td width="80" height="40" align="left" class="text_cray1">电子邮箱：</td>
                            <td align="left" class="text_cray"><input class="form-control" type="email" name="email"/></td>
                        </tr>
                        <tr>
                            <td width="120" height="40" align="left" class="text_cray1">生 日：</td>
                            <td colspan="2" align="left" class="text_cray"><input class="form-control" type="text" name="birthday"/></td>
                        </tr>
